...
char *the_realloc(char *ptr, unsigned int old_size, unsigned int new_size);
ssize_t the_getstdin(char **lineptr, int file);
char  *the_clean_line(char *content);
void the_push(stack_t **head, unsigned int number);
void the_pall(stack_t **head, unsigned int number);
void the_pint(stack_t **head, unsigned int number);
int the_execute(char *content, stack_t **head, unsigned int counter, FILE *file);
...
void the_nop(stack_t **head, unsigned int counter);
...
void the_rotl(stack_t **head, unsigned int counter);
